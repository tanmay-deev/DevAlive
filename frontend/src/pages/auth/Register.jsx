...
export function Register() {
  ...
  const { register, googleLogin, isLoading, error, isAuthenticated, clearError } = useAuthStore();
  ...
  return (
    <div className="w-full flex flex-col">
      <div className="mb-10 text-center lg:text-left">
        <h2 className="text-3xl md:text-4xl font-headline font-bold text-white mb-3 tracking-tight">Create Account</h2>
        <p className="text-on-surface-variant text-base">Get started with free monitoring.</p>
      </div>
