  ...
  return (
    <div className="bg-card border border-border p-8 md:p-10 rounded-[1rem] shadow-2xl w-full">
      <div className="mb-8 text-center lg:text-left">
        <h2 className="text-3xl font-headline font-bold text-white mb-2">Welcome Back</h2>
        <p className="text-on-surface-variant">Sign in to continue monitoring your projects.</p>
      </div>
